...
import com.microservices.OrderService.exception.CustomeException;
...
public class CustomErrorDecoder implements ErrorDecoder {
    ...
    public Exception decode(String s, Response response) {
        ...
        try {
            ...
            return new CustomeException(errorResponse.getErrorMessage(),errorResponse.getErrorCode(),response.status());
        } catch (IOException e) {
